---
name: code-refactor
description: Systematically analyze and refactor code to improve quality without changing behavior.
origin: ECC
---
...
- Runs existing tests (`pytest`) after each refactoring step
...
```
/refactor src/locus/utils.py
```

Analyzes utils.py and applies targeted refactorings with test verification at each step.
